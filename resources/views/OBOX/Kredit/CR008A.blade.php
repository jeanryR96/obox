        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">CR008-A</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title"><i class="fa fa-users"></i><strong> Debitur Penurunan Baki Debet Terbesar</strong></h3>
            </div>
        </div>
        <!-- /.card-header -->
        <div class="card">
                ...
                <table class="table table-bordered table-head-fixed table-sm text-nowrap">
                    <thead style="height: 40px; text-align:center; color:#f5f5f5;">
                        <tr>
                            ...
                            <th style="background-color:#17a2b8;">Jenis DPK/Simpanan Dari Bank Lain</th>
                            <th style="background-color:#17a2b8;">Nominal</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
